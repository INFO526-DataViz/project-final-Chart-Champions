...
plot_celestial_map <- function(grat_end, const_end, mw_end, stars_end, 
                               target_crs, hemisphere_s2, caption, glowint, bg_fill_col, show_const_name) {
...
get_default_celestial_map <- function(show_const_name = FALSE) {
    # const name parameter for default plot as well
